    ...
    <>
      <div className="flex flex-col md:flex-row sticky top-0 inset-0 h-fit px-4 py-2 sm:gap-4 bg-red-600 shadow-sm shadow-red-600/40">
        <div className="flex gap-2 px-2 sm:px-0 items-center justify-between pb-2 sm:pb-0">
          <Menu className="size-7 shrink-0 stroke-2 text-white block md:hidden" />
          <Link to="/">
            <img
              src={assets.logo}
              alt="La Económica"
              className="flex h-13 object-contain"
            />
          </Link>
          <ShoppingCart className="size-7 shrink-0 stroke-[1.5px] text-white md:hidden" />
        </div>
